...
MAINTENANCE:
  MAINTENANCE QUARTERLY:
    ...
    SOON TO BE OBSOLETE - MAP SCIENCE IS NOW ALL "GENERAL SCIENCE"
...
CREATE VIEW MAP$sci_cp_wide AS
...
LEFT OUTER JOIN MAP$comprehensive#identifiers map_s13
 ...
 AND map_s13.measurementscale = 'Science - Concepts and Processes'
 AND map_s13.rn=1
LEFT OUTER JOIN MAP$comprehensive#identifiers map_w12
 ...
 AND map_w12.measurementscale = 'Science - Concepts and Processes'
 AND map_w12.rn=1
LEFT OUTER JOIN MAP$comprehensive#identifiers map_f12
 ...
 AND map_f12.measurementscale = 'Science - Concepts and Processes'
 AND map_f12.rn=1
LEFT OUTER JOIN MAP$comprehensive#identifiers map_s12
 ...
 AND map_s12.measurementscale = 'Science - Concepts and Processes'
 AND map_s12.rn=1
LEFT OUTER JOIN MAP$comprehensive#identifiers map_w11
 ...
 AND map_w11.measurementscale = 'Science - Concepts and Processes'
 AND map_w11.rn=1
LEFT OUTER JOIN MAP$comprehensive#identifiers map_f11
 ...
 AND map_f11.measurementscale = 'Science - Concepts and Processes'
 AND map_f11.rn=1
LEFT OUTER JOIN MAP$comprehensive#identifiers map_s11
 ...
 AND map_s11.measurementscale = 'Science - Concepts and Processes'
 AND map_s11.rn=1
LEFT OUTER JOIN MAP$comprehensive#identifiers map_w10
 ...
 AND map_w10.measurementscale = 'Science - Concepts and Processes'
 AND map_w10.rn=1
LEFT OUTER JOIN MAP$comprehensive#identifiers map_f10
 ...
 AND map_f10.measurementscale = 'Science - Concepts and Processes'
 AND map_f10.rn=1
LEFT OUTER JOIN MAP$comprehensive#identifiers map_s10
 ...
 AND map_s10.measurementscale = 'Science - Concepts and Processes'
 AND map_s10.rn=1
