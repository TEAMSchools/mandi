...
Select distinct s.id, s.lastfirst, s.grade_level, s.schoolid,
  ...
  AND NJASK08.subject        =  ''Math''                            --subject
  ...
  AND NJASK07.subject        =  ''Math''                            --subject
  ...
  AND NJASK03.subject        =  ''Math''                            --subject
  ...
  AND NJASK04.subject        =  ''Math''                            --subject
  ...
  AND NJASK05.subject        =  ''Math''                            --subject
  ...
  AND NJASK06.subject        =  ''Math''                            --subject
