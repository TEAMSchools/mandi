--unique standards tested by year, school, grade, and subject
--the big output here is the row number, which can get open up some really interesting reporting

--short-lived, this is a static table now
