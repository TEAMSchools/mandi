...
ALTER PROCEDURE [sp_REPORTING$progress_tracker#NCA#static|refresh] AS
BEGIN
  ...
  FROM REPORTING$progress_tracker#NCA;
  ...
  INSERT INTO [REPORTING$progress_tracker#NCA#static]
  SELECT *
