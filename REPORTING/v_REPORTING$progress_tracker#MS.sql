...
--COURSE GRADES
      ...
      ,CASE WHEN CONVERT(FLOAT,eng.need_70) < 70 THEN 70 ELSE CONVERT(FLOAT,eng.need_70) END AS ENGLISH_need_c
      ...
      ,CASE WHEN CONVERT(FLOAT,MATH.need_70) < 70 THEN 70 ELSE CONVERT(FLOAT,MATH.need_70) END AS MATH_need_c
      ...
      ,CASE WHEN CONVERT(FLOAT,science.need_70) < 70 THEN 70 ELSE CONVERT(FLOAT,science.need_70) END AS science_need_c
      ...
      ,CASE WHEN CONVERT(FLOAT,soc.need_70) < 70 THEN 70 ELSE CONVERT(FLOAT,soc.need_70) END AS soc_need_c
