       ...
       (SELECT studentid
        ...
        FROM
            ...
            FROM
                ...
                (SELECT studentid
                      ...
                      ,SUM(att_value) OVER
                         (PARTITION BY studentid
                                      ...
                                      ,reporting_hash
                          ORDER BY studentid
                                  ,calendardate) AS rolling_att
                      ,MAX(reporting_hash) OVER
                          (PARTITION BY studentid
                                       ,grade_level
                                       ,yearid
                          ORDER BY studentid
                                  ,calendardate) AS max_hash
                      ,MIN(reporting_hash) OVER
                          (PARTITION BY studentid
                                       ,grade_level
                                       ,yearid
                          ORDER BY studentid
                                  ,calendardate) AS min_hash
                FROM 
                ...
                GROUP BY studentid, school, grade_level, yearid, calendardate
                        ,reporting_hash, mem_value, att_value
                ) level_3
            GROUP BY studentid
                    ,school
                    ,grade_level
