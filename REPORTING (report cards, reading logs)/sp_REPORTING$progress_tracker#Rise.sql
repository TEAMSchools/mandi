...
BEGIN
 ...
 --STEP 1: make sure no temp table
		IF OBJECT_ID(N'tempdb..#REPORTING$progress_tracker#Rise_static|refresh') IS NOT NULL
		BEGIN
						DROP TABLE [#REPORTING$progress_tracker#Rise_static|refresh]
		END
 ...
 SELECT *
 FROM [#REPORTING$progress_tracker#Rise_static|refresh];
