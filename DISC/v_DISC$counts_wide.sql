...
SELECT log.studentid
      ...
      ,SUM(CASE WHEN log.subtype = 'Bench / Choices' THEN 1 ELSE NULL END) choices
      ,SUM(CASE WHEN log.subtype = 'Bench / Choices' THEN 1 ELSE NULL END) bench
      ...
      ,SUM(CASE WHEN log.subtype = 'Bench / Choices' AND log.rt = 'RT1' THEN 1 ELSE NULL END) rt1_choices
      ,SUM(CASE WHEN log.subtype = 'Bench / Choices' AND log.rt = 'RT1' THEN 1 ELSE NULL END) rt1_bench
      ...
      ,SUM(CASE WHEN log.subtype = 'Bench / Choices' AND log.rt = 'RT2' THEN 1 ELSE NULL END) rt2_choices
      ,SUM(CASE WHEN log.subtype = 'Bench / Choices' AND log.rt = 'RT2' THEN 1 ELSE NULL END) rt2_bench
      ...
      ,SUM(CASE WHEN log.subtype = 'Bench / Choices' AND log.rt = 'RT3' THEN 1 ELSE NULL END) rt3_choices
      ,SUM(CASE WHEN log.subtype = 'Bench / Choices' AND log.rt = 'RT3' THEN 1 ELSE NULL END) rt3_bench
      ...
      ,SUM(CASE WHEN log.subtype = 'Bench / Choices' AND log.rt = 'RT4' THEN 1 ELSE NULL END) rt4_choices
      ,SUM(CASE WHEN log.subtype = 'Bench / Choices' AND log.rt = 'RT4' THEN 1 ELSE NULL END) rt4_bench
      ...
      ,SUM(CASE WHEN log.subtype = 'Bench / Choices' AND log.rt = 'RT5' THEN 1 ELSE NULL END) rt5_choices
      ,SUM(CASE WHEN log.subtype = 'Bench / Choices' AND log.rt = 'RT5' THEN 1 ELSE NULL END) rt5_bench
      ...
      ,SUM(CASE WHEN log.subtype = 'Bench / Choices' AND log.rt = 'RT6' THEN 1 ELSE NULL END) rt6_choices
      ,SUM(CASE WHEN log.subtype = 'Bench / Choices' AND log.rt = 'RT6' THEN 1 ELSE NULL END) rt6_bench
      ...
      ,SUM(CASE WHEN log.subtype = 'Bench / Choices' AND log.rt = curterm.time_per_name THEN 1 ELSE NULL END) cur_choices
      ,SUM(CASE WHEN log.subtype = 'Bench / Choices' AND log.rt = curterm.time_per_name THEN 1 ELSE NULL END) cur_bench
