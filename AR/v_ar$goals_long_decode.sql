         ...
         FROM  
               (SELECT ar.* 
                ...
                SELECT NULL AS ID
                      ...
                      ,CASE
                         WHEN schoolid = 73252 THEN '2014-06-07'
                         WHEN schoolid = 133570965 THEN '2014-08-13'
                         WHEN schoolid = 73253 THEN '2014-06-12' 
                       END AS time_period_start
                      ,CASE
                         WHEN schoolid = 73252 THEN '2015-06-06'
                         WHEN schoolid = 133570965 THEN '2015-08-12'
                         WHEN schoolid = 73253 THEN '2015-06-11' 
                       END AS time_period_end
