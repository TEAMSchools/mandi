...
ALTER PROCEDURE [sp_AR$test_event_detail#static|refresh] AS
BEGIN
  ...
  FROM AR$test_event_detail;
         

  -- STEP 3: truncate destination table
  EXEC('TRUNCATE TABLE KIPP_NJ..AR$test_event_detail#static');
  ...
  INSERT INTO [AR$test_event_detail#static]
  SELECT *
