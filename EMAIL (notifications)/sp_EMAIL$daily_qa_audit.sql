...
BEGIN
 ...
 ,@return_value        INT
  ...
  EXECUTE AlumniMirror.dbo.sp_TableToHTML @sql_audits, @html_audits OUTPUT  
...
<body> 
		...
		<br>
		<br>
  <span style="med_text">Daily data audits</span> 
'
+ @html_audits +
'
  <br>
