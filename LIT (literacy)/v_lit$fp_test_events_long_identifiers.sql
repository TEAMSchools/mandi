...
--*/
      ,CASE WHEN highest.step_ltr_level IS NULL THEN last_step.step_ltr_level ELSE highest.step_ltr_level END AS la_reading_lvl
      ...
      ,CASE
        WHEN highestms.step_ltr_level IS NULL THEN CONVERT(VARCHAR,last_step.step_ltr_level)
        ELSE CONVERT(VARCHAR,highestms.step_ltr_level)
       END AS la_reading_lvl_ms
      ,CASE
        WHEN highestms.GLEQ IS NULL THEN last_step.GLEQ
        ELSE highestms.GLEQ 
       END AS la_GLEQ_ms
      ,CASE
...
--*/
--/*
--LAST STEP ACHIEVED BEFORE MOVING TO F&P
LEFT OUTER JOIN 
     (
      SELECT *
      FROM
