...
SELECT sec.ID AS sectionid
      ...
      ,CASE WHEN gb.FINALGRADESETUPTYPE = 'TotalPoints' THEN 100 ELSE gb.WEIGHTING END AS weighting
      ,CASE WHEN gb.FINALGRADESETUPTYPE = 'TotalPoints' THEN 1 ELSE gb.INCLUDEINFINALGRADES END AS INCLUDEINFINALGRADES
      ,gb.DEFAULTSCORETYPE            
